    ...
    <form class="row" method="POST">
        ...
        <div class="form-group col-6">
            ...
            <input name="name" type="text"
                ...
                placeholder="Họ tên..." value="{{ $user->name ?? old('name') }}" />
            @error('name')
        ...
        <div class="form-group col-6">
            ...
            <select name="group_id"
                ...
                <option value="1" {{ ($user->group_id ?? old('group_id')) == 1 ? 'selected' : false }}>Admin</option>
                <option value="2" {{ ($user->group_id ?? old('group_id')) == 2 ? 'selected' : false }}>Quản lý</option>
                <option value="3" {{ ($user->group_id ?? old('group_id')) == 3 ? 'selected' : false }}>Người dùng
                    thường</option>
            </select>
            @error('group_id')
                <div class="invalid-feedback">
