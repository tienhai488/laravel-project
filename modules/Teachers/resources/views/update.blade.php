...
@section('title', 'Cập nhập giảng viên')
@section('content')
    @if ($errors->any())
    ...
    <form class="row" method="POST">
        ...
        <div class="form-group col-6">
            ...
            <input name="name" type="text"
                ...
                placeholder="Tên giảng viên..." value="{{ old('name') ?? $teacher->name }}" />
            @error('name')
        ...
        <div class="form-group col-6">
            ...
            <input name="slug" type="text"
                ...
                placeholder="Slug..." value="{{ old('slug') ?? $teacher->slug }}" />
            @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group col-6">
            ...
            <input name="exp" type="number"
                ...
                placeholder="Sô năm kinh nghiệm..." value="{{ old('exp') ?? $teacher->exp }}" />
            @error('exp')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
